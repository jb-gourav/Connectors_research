 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://poc.soap.org/", wsdlLocation = "http://localhost:8080/MyApp/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://poc.soap.org/", "HelloService");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://poc.soap.org/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://poc.soap.org/", "HelloPort"), Hello.class, features);
    }
